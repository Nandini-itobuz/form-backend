...
import { createApplication, findApplication, getAllApplications, deleteApplication, updateApplication, 
	getApplicationsByPositions, deleteAllApplications } from "../controllers/applicationController";
...
applicationRoutes.post('/create-application', checkEmailExists ,handleValidations , createApplication)
...
applicationRoutes.put('/update-application/:id', handleValidations, updateApplication)
